function [optknock_results,robokod_results,optgene_results,screening_results_max,screening_results_min] = ...
                optPipe(cobra_model,BM_rxn,target_rxn,max_KOs,branchId)
...
if ~hasrelevant
    [irrel relevantRxns selectedRxnIDs] = irrelevantRxns(cobra_model,BM_rxn);
