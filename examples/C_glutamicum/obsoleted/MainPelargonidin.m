...
savepath;
a=strfind(pathstr,'/');
result_dir=strcat(pathstr(1:a(end)),'Results_glutamicum/pelargonidin');
mkdir(result_dir);
...
cobra_model=Get_heterologous(model,'pelargonidin');
...
%Export model
writeCbModel(cobra_model,'sbml',strcat(result_dir,'/','pelargonidin_model'));
...
[num,optgene_results,raw] = xlsread(strcat(result_dir,'/optgene_pelargonidin.xlsx'));
...
%For windows:
%xlswrite('pelargonidin_results',all_rxns,'All KOs') 
%xlswrite('pelargonidin_results.xls',table_subsystems,'Subsystems enrichment');
%xlswrite('pelargonidin_results.xls',table_all_comb,'All KO combinations');
%xlswrite('pelargonidin_results.xls',table_best_comb,'Best KO combinations');
...
xlwrite('pelargonidin_results.xls',all_rxns,'All KO reactions'); %put formulas
xlwrite('pelargonidin_results.xls',table_subsystems,'Subsystems enrichment');
xlwrite('pelargonidin_results.xls',table_results,'All KO combinations');
xlwrite('pelargonidin_results.xls',table_best_results,'Best KO combinations');
